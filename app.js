...
var _jhf$adventofcode$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _jhf$adventofcode$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _jhf$adventofcode$Main$init = {
	ctor: '_Tuple2',
	_0: {},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _jhf$adventofcode$Main$Model = {};
var _jhf$adventofcode$Main$Heading = {ctor: 'Heading'};
var _jhf$adventofcode$Main$None = {ctor: 'None'};
var _jhf$adventofcode$Main$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_jhf$adventofcode$Main$None,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_jhf$adventofcode$Main$Heading,
				{
					ctor: '::',
...
var _jhf$adventofcode$Main$view = function (model) {
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_jhf$adventofcode$Main$stylesheet,
					...
					_0: A3(
						...
						{ctor: '[]'},
						{
							...
							_0: A3(
								...
								_jhf$adventofcode$Main$Heading,
								{ctor: '[]'},
								_mdgriffith$style_elements$Element$text('Advent Of Code 2017')),
							_1: {
								ctor: '::',
								_0: A3(
									_mdgriffith$style_elements$Element$el,
									_jhf$adventofcode$Main$None,
									{ctor: '[]'},
									_mdgriffith$style_elements$Element$text('Day 1')),
								_1: {
									ctor: '::',
									_0: A3(
										_mdgriffith$style_elements$Element$el,
										_jhf$adventofcode$Main$None,
										{ctor: '[]'},
										_mdgriffith$style_elements$Element$text('Day 2')),
									_1: {
										ctor: '::',
										_0: A3(
											_mdgriffith$style_elements$Element$el,
											_jhf$adventofcode$Main$None,
											{ctor: '[]'},
											_mdgriffith$style_elements$Element$text('Day 3')),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _jhf$adventofcode$Main$main = _elm_lang$html$Html$program(
	{init: _jhf$adventofcode$Main$init, view: _jhf$adventofcode$Main$view, update: _jhf$adventofcode$Main$update, subscriptions: _jhf$adventofcode$Main$subscriptions})();
var _jhf$adventofcode$Main$Nothing = {ctor: 'Nothing'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _jhf$adventofcode$Main$main !== 'undefined') {
    _jhf$adventofcode$Main$main(Elm['Main'], 'Main', undefined);
}
